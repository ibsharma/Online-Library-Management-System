<%@ page title="" language="C#" masterpagefile="~/LibAdmin.master" autoeventwireup="true" inherits="DefaulterReport, App_Web_2vag3bbd" %>
...
<center>
    <table>
        ...
        <tr align="left">
            ...
            <td colspan="4" class="style10">
                <asp:DropDownList ID="ddlMonth" runat="server" Height="25px" Width="151px" 
                    Visible="False">
    ...
    <table>
        ...
        <TR>
            <td colspan="2">
    <asp:GridView ID="gvDefaulterReport" runat="server" HorizontalAlign="Center" 
